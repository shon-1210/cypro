...
checkpoint <- function(evaluate = TRUE,
                       ...
                       error_notifications = list(
                         ...
                         "invalid_exp_name" = "Invalid experiment name. Must start with a letter and must not contain empty space.",
                         "invalid_example_df" = "The example data must have at least four columns.",
                         "invalid_roi_number" = "The number of regions of interest per well must not be 0.",
                         "invalid_n_frames" = "The number of frames must not be 0.",
                         "invalid_wp_name" = "Invalid or already existing well plate name. Must start with a letter and must not contain empty space or '-'.",
